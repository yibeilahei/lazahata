...
void HalDisplay::displayGrayBufferStart(bool turnOffScreen) { einkDisplay.displayGrayBufferStart(turnOffScreen); }

void HalDisplay::waitGrayDisplay() { einkDisplay.waitGrayDisplay(); }
